...
public class GatewayConfiguration {
     ...
     */
    @Bean
    public AccessLocator accessLocator(ZuulRouteLocator zuulRoutesLocator, RateLimitProperties rateLimitProperties, BaseAuthorityRemoteService baseAuthorityRestService, GatewayIpLimitRemoteService gatewayIpLimitRestService, GatewayRateLimitRemoteService gatewayRateLimitRestService) {
        accessLocator = new AccessLocator(zuulRoutesLocator,rateLimitProperties, baseAuthorityRestService, gatewayIpLimitRestService,gatewayRateLimitRestService);
     ...
     */
    @Bean
    public ZuulRouteLocator zuulRouteLocator(ZuulProperties zuulProperties, ServerProperties serverProperties, GatewayRouteRemoteService gatewayRouteRestService) {
