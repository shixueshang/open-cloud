...
@RestController
public class ClientDetailsRemoteController implements ClientDetailsRemoteApi {

    @Autowired
    private CustomClientDetailsService clinetInfoService;
    ...
    @GetMapping("/client")
    @Override
    public ResultBody<PageList<BaseClientDetailsDto>> client() {
    ...
    @Override
    public ResultBody<BaseClientDetailsDto> getClient(
    ...
    public ResultBody<Boolean> addClient(
        ...
        boolean result = clinetInfoService.addClient(clientId, clientSecret, grantTypes, autoApproveScopes, redirectUrls, scopes, resourceIds, authorities, accessTokenValidity,refreshTokenValidity, clientInfo);
    ...
    public ResultBody<Boolean> updateClient(
        ...
        boolean result = clinetInfoService.updateClient(clientId, grantTypes, autoApproveScopes, redirectUrls, scopes, resourceIds, authorities,accessTokenValidity,refreshTokenValidity, clientInfo);
        return result ? ResultBody.success() : ResultBody.failed();
    }
