...
public class ProcessEngineService {
     ...
     * @return
     */
    public PageList<Task> findTodoTask(String userId, int firstResult, int maxResults) {
        //得到用户待办
        ...
        return new PageList(list, query.count());
    }
     ...
     * @return
     */
    public PageList<ProcessDefinition> findProcessDefinition(String key, int firstResult, int maxResults) {
